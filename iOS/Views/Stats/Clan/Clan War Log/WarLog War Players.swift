...
extension ClanBaseView.WarLogView.WarView {
    ...
    @ViewBuilder
    private func makePlayerContextMenu(player: OAPI.Models.ClanWarLog.Participant) -> some View {
        let tag = player.tag
