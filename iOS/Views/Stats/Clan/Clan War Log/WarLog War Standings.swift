    ...
    struct WarView: View {
        ...
        var body: some View {
            BGStack {
                ZStack {
                    makeStandings()
                    ClanBaseView.WarSortMenu()
                }
            }
            .navigationTitle("War")
            .navigationBarTitleDisplayMode(.inline)
            .navigationBarBackButtonHidden(Device.isPad)
            .navigationBarItems(leading: IPadBackButton(
                                    title: "Back To War Log",
        ...
        private func trailingButton() -> some View {
            HStack(spacing: 0) {
                ...
                Button(action: {
                    withAnimation {
                        sortMenuValues.menuIsVisible.toggle()
                    }
                })
                {
        ...
        private func makeStandings() -> some View {
            CustomScrollView {
