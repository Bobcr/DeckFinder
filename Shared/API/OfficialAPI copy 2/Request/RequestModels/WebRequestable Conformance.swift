//
//  WebRequestable Conformance.swift
//  iOS
//
//  Created by Mohammad on 7/8/20.
//

import Foundation
import SwiftUI

private typealias ReqModels = OAPI.Requests

extension ReqModels.PlayerProfile: WebRequestable {
...
extension ReqModels.PlayerBattles: WebRequestable {
    typealias TypeToDecodeTo = Array<OAPI.CodableModels.PlayerBattle>
...
extension ReqModels.PlayerChests: WebRequestable {
    typealias TypeToDecodeTo = OAPI.CodableModels.PlayerChests
...
extension ReqModels.ClanProfile: WebRequestable {
...
extension ReqModels.ClanCurrentWar: WebRequestable {
...
extension ReqModels.ClanWarLog: WebRequestable {
...
extension ReqModels.ClanNameSearch: WebRequestable {
...
extension ReqModels.ClanNameSearch {
...
extension ReqModels.PlayerLeaderboard: WebRequestable {
    typealias TypeToDecodeTo = OAPI.CodableModels.PlayerLeaderboard

    func urlString() -> String? {
        let location = locationId == -1 ? "global" : "\(locationId)"
        return OAPI.baseUrl + "locations/\(location)/rankings/players"
    }
}

extension ReqModels.ClanLeaderboard: WebRequestable {
...
extension ReqModels.GlobalTourneyInfo: WebRequestable {
...
extension ReqModels.GlobalTourneyLeaderboard: WebRequestable {
