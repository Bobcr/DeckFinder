    ...
    struct Card: Codable, EmptyInitializable {
        ...
        func populate() -> Self {
            return .init(name: self.name,
                         ...
                         level: Funcs.Card.level(oldLevel: self.oldLevel,
...
extension PlayerBattle {
    func populate() -> OfficialAPI.Models.PlayerBattle {
        return .init(type: self.type,
                     challengeTitle: self.challengeTitle,
                     title: Funcs.Battle.title(battleName: gameMode.name,
                                               challengeTitle: self.challengeTitle,
...
extension Array where Element == OAPI.Models.PlayerBattle {
    func populate() -> Array<OAPI.Models.PlayerBattle> {
