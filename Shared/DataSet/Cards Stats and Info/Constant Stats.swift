...
extension DataSet.Cards {
    var constantStats: ConstantStats {
        ...
        case .miniPekka: return ConstantStats(elixir: 4, hitSpeed: 1.8, targets: "Ground", speed: "Fast", range: "Melee: Short")
        ...
        case .eliteBarbarians: return ConstantStats(elixir: 6, hitSpeed: 1.7, targets: "Ground", speed: "Very Fast", range: "Melee: Medium", count: 2)
        case .goblinGiant: return ConstantStats(elixir: 6, hitSpeed: 1.7, targets: "Buildings", speed: "Medium", range: "Melee: Medium", subTroopsCount: 2)
        case .elixirCollector: return ConstantStats(elixir: 6, lifetime: 70, productionSpeed: 8.5)
        case .xBow: return ConstantStats(elixir: 6, hitSpeed: 0.2, targets: "Ground", range: "11.5", lifetime: 40, deployTime: 3.5)
